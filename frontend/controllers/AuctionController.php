...
class AuctionController extends Controller
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                    'actions' => ['index','view','preview','round','personal-round'],
                    'allow' => true,
                    'roles' => ['?'],
                    ],
                ],
    ...
    public function actionIndex()
    {
        ...
        if(isset($_GET['cateid'])){
            ...
            $dataProvider = new ActiveDataProvider([
                'query'=>AuctionGoods::find()->andWhere(" cateid=$cateid and status=1 and auth_status=1 and post_type=1")->orderBy('sort desc,created_at asc'),
                'pagination'=>[
                    'pagesize'=>20
                ]
            ]);
            ...
            $dataProvider = new ActiveDataProvider([
                'query'=>AuctionGoods::find()->andWhere("  status=1 and auth_status=1 and post_type=1")->orderBy('sort desc,created_at asc'),
                'pagination'=>[
                    'pagesize'=>20
                ]
                ]);
    ...
    public function actionPreview()
    {
        ...
        if(isset($_GET['cateid'])){
            $cateid=$_GET['cateid'];
            $dataProvider = new ActiveDataProvider([
                'query'=>AuctionGoods::find()->andWhere(" cateid=$cateid and start_time > $now and auth_status=1 and post_type=1")->orderBy('sort desc,created_at ASC'),
                'pagination'=>[
                    'pagesize'=>18
                ]
            ]);
        ...
        $dataProvider = new ActiveDataProvider([
            'query'=>AuctionGoods::find()->andWhere("  start_time > $now and auth_status=1 and post_type=1")->orderBy('sort desc,created_at ASC'),
                'pagination'=>[
                    'pagesize'=>18
                ]
            ]);
